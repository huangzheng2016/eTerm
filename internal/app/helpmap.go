...
func (h homeAppHelpMap) FullHelp() [][]key.Binding {
	return [][]key.Binding{
		{h.km.QuitApp, h.km.LocalTerminal, h.km.RenameTab, h.km.NewTab, h.km.CloseTabSafe, h.km.ToggleChrome},
